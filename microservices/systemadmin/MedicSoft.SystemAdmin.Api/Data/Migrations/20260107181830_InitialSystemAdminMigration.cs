...
{
    /// <inheritdoc />
    public partial class InitialSystemAdminMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManualOverrideSetBy = table.Column<string>(type: "text", nullable: true),
                    ManualOverrideSetAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ManualOverrideExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TenantId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_Status_TenantId",
                table: "Tickets",
                columns: new[] { "Status", "TenantId" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TenantId_ClinicId",
                table: "Tickets",
                columns: new[] { "TenantId", "ClinicId" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TenantId_UserId",
                table: "Tickets",
