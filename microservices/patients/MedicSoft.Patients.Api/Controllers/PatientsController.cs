...
namespace MedicSoft.Patients.Api.Controllers;

[Route("api/[controller]")]
public class PatientsController : MicroserviceBaseController
{
    ...
    {
        return Ok(new { status = "healthy", service = "Patients.Microservice" });
    }
}
