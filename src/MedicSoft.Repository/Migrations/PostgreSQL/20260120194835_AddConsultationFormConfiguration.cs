...
{
    /// <inheritdoc />
    public partial class AddConsultationFormConfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowChiefComplaint = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ShowHistoryOfPresentIllness = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ShowPastMedicalHistory = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ShowFamilyHistory = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ShowLifestyleHabits = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ShowCurrentMedications = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultationFormProfiles", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ConsultationFormConfigurations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultationFormConfigurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultationFormConfigurations_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultationFormConfigurations_ConsultationFormProfiles_Pro~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormConfigurations_ClinicId",
                table: "ConsultationFormConfigurations",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormConfigurations_ProfileId",
                table: "ConsultationFormConfigurations",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormConfigurations_TenantId",
                table: "ConsultationFormConfigurations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormConfigurations_TenantId_ClinicId_IsActive",
                table: "ConsultationFormConfigurations",
                columns: new[] { "TenantId", "ClinicId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormConfigurations_TenantId_ProfileId",
                table: "ConsultationFormConfigurations",
                columns: new[] { "TenantId", "ProfileId" });

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormProfiles_TenantId",
                table: "ConsultationFormProfiles",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormProfiles_TenantId_IsSystemDefault",
                table: "ConsultationFormProfiles",
                columns: new[] { "TenantId", "IsSystemDefault" });

            migrationBuilder.CreateIndex(
                name: "IX_ConsultationFormProfiles_TenantId_Specialty_IsActive",
                table: "ConsultationFormProfiles",
                columns: new[] { "TenantId", "Specialty", "IsActive" });
        }
