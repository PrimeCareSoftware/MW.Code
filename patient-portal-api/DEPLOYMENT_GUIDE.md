...
- PostgreSQL database (same as MedicWarehouse main application)
...
**IMPORTANT:** Before running the SQL scripts, verify the schema matches your MedicWarehouse database.
