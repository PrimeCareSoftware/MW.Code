...
{
    /// <inheritdoc />
    public partial class AddBruteForceProtectionTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockedBy = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountLockouts_TenantId",
                table: "AccountLockouts",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountLockouts_UserId_IsActive_UnlocksAt",
                table: "AccountLockouts",
                columns: new[] { "UserId", "IsActive", "UnlocksAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAttempts_Username_WasSuccessful_AttemptTime",
                table: "LoginAttempts",
                columns: new[] { "Username", "WasSuccessful", "AttemptTime" });
        }
