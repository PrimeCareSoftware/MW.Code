...
{
    /// <inheritdoc />
    public partial class AddSoapRecords : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // PaidAt column is already created with correct type in AddPaymentTrackingFields migration
            // No need to alter it here
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assessment = table.Column<string>(type: "jsonb", nullable: true),
                    Objective = table.Column<string>(type: "jsonb", nullable: true),
                    Plan = table.Column<string>(type: "jsonb", nullable: true),
                    Subjective = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoapRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoapRecords_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SoapRecords_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SoapRecords_Users_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_AppointmentId",
                table: "SoapRecords",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_DoctorId",
                table: "SoapRecords",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_PatientId",
                table: "SoapRecords",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId",
                table: "SoapRecords",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId_Appointment",
                table: "SoapRecords",
                columns: new[] { "TenantId", "AppointmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId_Doctor",
                table: "SoapRecords",
                columns: new[] { "TenantId", "DoctorId" });

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId_IsComplete",
                table: "SoapRecords",
                columns: new[] { "TenantId", "IsComplete" });

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId_IsLocked",
                table: "SoapRecords",
                columns: new[] { "TenantId", "IsLocked" });

            migrationBuilder.CreateIndex(
                name: "IX_SoapRecords_TenantId_Patient",
                table: "SoapRecords",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // PaidAt column type is managed by AddPaymentTrackingFields migration
            // No need to alter it here
