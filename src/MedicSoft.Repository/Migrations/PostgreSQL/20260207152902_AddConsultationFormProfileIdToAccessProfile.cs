...
{
    /// <inheritdoc />
    public partial class AddConsultationFormProfileIdToAccessProfile : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Only alter CustomDashboards if the table exists
            migrationBuilder.Sql(@"
                DO $$
                BEGIN
            ...
            migrationBuilder.AddColumn<Guid>(
                name: "ConsultationFormProfileId",
                table: "AccessProfiles",
                type: "uuid",
                nullable: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessProfiles_ConsultationFormProfileId",
                table: "AccessProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipants_UserId_IsActive",
                table: "ChatParticipants",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Only alter CustomDashboards if the table exists (Down)
            migrationBuilder.Sql(@"
                DO $$
                BEGIN
                    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'customdashboards' AND table_schema = 'public') THEN
