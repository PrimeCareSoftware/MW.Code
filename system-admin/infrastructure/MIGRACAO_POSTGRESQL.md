...
✅ **MIGRAÇÃO COMPLETA!** O Omni Care Software agora usa PostgreSQL por padrão, com suporte retrocompatível para SQL Server.
...
Server=localhost,1433;Database=Omni Care Software;User Id=sa;Password=...
```
...
LOAD DATABASE
  FROM mssql://sa:password@localhost/Omni Care Software
