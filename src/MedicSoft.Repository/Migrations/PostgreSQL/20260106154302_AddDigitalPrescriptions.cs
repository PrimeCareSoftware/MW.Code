...
{
    /// <inheritdoc />
    public partial class AddDigitalPrescriptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SequenceNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    DoctorCRM = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    DoctorCRMState = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    PatientName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    PatientDocument = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    DigitalSignature = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    SignedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SignatureCertificate = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    VerificationCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RequiresSNGPCReport = table.Column<bool>(type: "boolean", nullable: false),
                    ReportedToSNGPCAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DigitalPrescriptions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DigitalPrescriptions_Users_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                name: "PrescriptionSequenceControls",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    ...
                    LastGeneratedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionSequenceControls", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransmissionProtocol = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    PrescriptionIds = table.Column<string>(type: "jsonb", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TenantId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SNGPCReports", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlledList = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalPrescriptionItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DigitalPrescriptionItems_DigitalPrescriptions_DigitalPrescr~",
                        column: x => x.DigitalPrescriptionId,
                        principalTable: "DigitalPrescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DigitalPrescriptionItems_Medications_MedicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptionItems_MedicationId",
                table: "DigitalPrescriptionItems",
                column: "MedicationId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptionItems_TenantId_Controlled",
                table: "DigitalPrescriptionItems",
                columns: new[] { "TenantId", "IsControlledSubstance" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptionItems_TenantId_PrescriptionId",
                table: "DigitalPrescriptionItems",
                columns: new[] { "TenantId", "DigitalPrescriptionId" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_Active_Expiration",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_PatientId",
                table: "DigitalPrescriptions",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_SNGPC_Reporting",
                table: "DigitalPrescriptions",
                columns: new[] { "TenantId", "RequiresSNGPCReport", "ReportedToSNGPCAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_TenantId_DoctorId",
                table: "DigitalPrescriptions",
                columns: new[] { "TenantId", "DoctorId" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_TenantId_MedicalRecordId",
                table: "DigitalPrescriptions",
                columns: new[] { "TenantId", "MedicalRecordId" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_TenantId_PatientId",
                table: "DigitalPrescriptions",
                columns: new[] { "TenantId", "PatientId" });

            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_TenantId_SequenceNumber",
                table: "DigitalPrescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalPrescriptions_VerificationCode",
                table: "DigitalPrescriptions",
                column: "VerificationCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionSequenceControls_TenantId_Year",
                table: "PrescriptionSequenceControls",
                columns: new[] { "TenantId", "Year" });

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionSequenceControls_Unique",
                table: "PrescriptionSequenceControls",
                columns: new[] { "TenantId", "Type", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SNGPCReports_TenantId_Month_Year",
                table: "SNGPCReports",
                columns: new[] { "TenantId", "Month", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SNGPCReports_TenantId_Status",
                table: "SNGPCReports",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_SNGPCReports_TenantId_Year",
                table: "SNGPCReports",
                columns: new[] { "TenantId", "Year" });

            migrationBuilder.CreateIndex(
                name: "IX_SNGPCReports_TransmissionProtocol",
                table: "SNGPCReports",
                column: "TransmissionProtocol");
        }
