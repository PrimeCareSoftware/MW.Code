...
{
    public class MedicalRecordTemplateTests
    {
        ...
        {
            // Arrange
            var name = "Consultation Template";
            var description = "General consultation template";
            var content = "Patient Name: {{patient.name}}\nDiagnosis: {{diagnosis}}";
            var category = "Consultation";

            // Act
            var template = new MedicalRecordTemplate(name, description, content, category, _tenantId);
        ...
        public void Constructor_WithEmptyName_ThrowsArgumentException()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() =>
                new MedicalRecordTemplate("", "Description", "Content", "Category", _tenantId));
        ...
        public void Constructor_WithEmptyTemplateContent_ThrowsArgumentException()
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() =>
                new MedicalRecordTemplate("Name", "Description", "", "Category", _tenantId));
        ...
        public void Constructor_WithEmptyCategory_ThrowsArgumentException()
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() =>
                new MedicalRecordTemplate("Name", "Description", "Content", "", _tenantId));
        ...
        {
            // Act
            var template = new MedicalRecordTemplate("Name", null!, "Content", "Category", _tenantId);
        ...
        private MedicalRecordTemplate CreateValidTemplate()
        {
            return new MedicalRecordTemplate(
                "Test Template",
                "Test Description",
                "Test Content",
                "Test Category",
