...
{
    /// <inheritdoc />
    public partial class AddDigitalSignatureTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroCertificado = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    CertificadoA1Criptografado = table.Column<byte[]>(type: "bytea", nullable: true),
                    ChavePrivadaA1Criptografada = table.Column<byte[]>(type: "bytea", nullable: true),
                    ...
                    TotalAssinaturas = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificadosDigitais_Users_MedicoId",
                        column: x => x.MedicoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicoId = table.Column<Guid>(type: "uuid", nullable: false),
                    CertificadoId = table.Column<Guid>(type: "uuid", nullable: false),
                    DataHoraAssinatura = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AssinaturaDigitalBytes = table.Column<byte[]>(type: "bytea", nullable: false),
                    HashDocumento = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TemTimestamp = table.Column<bool>(type: "boolean", nullable: false),
                    DataTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TimestampBytes = table.Column<byte[]>(type: "bytea", nullable: true),
                    Valida = table.Column<bool>(type: "boolean", nullable: false),
                    DataUltimaValidacao = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LocalAssinatura = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    IpAssinatura = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TenantId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssinaturasDigitais_CertificadosDigitais_CertificadoId",
                        column: x => x.CertificadoId,
                        principalTable: "CertificadosDigitais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssinaturasDigitais_Users_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssinaturasDigitais_DocumentoId_TipoDocumento",
                table: "AssinaturasDigitais",
                columns: new[] { "DocumentoId", "TipoDocumento" });

            migrationBuilder.CreateIndex(
                name: "IX_AssinaturasDigitais_MedicoId",
                table: "AssinaturasDigitais",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_AssinaturasDigitais_TenantId",
                table: "AssinaturasDigitais",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_CertificadosDigitais_MedicoId",
                table: "CertificadosDigitais",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_CertificadosDigitais_TenantId",
                table: "CertificadosDigitais",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_CertificadosDigitais_Thumbprint",
                table: "CertificadosDigitais",
                column: "Thumbprint",
                unique: true);
        }
