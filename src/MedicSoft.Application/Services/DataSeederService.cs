    ...
    public class DataSeederService
    {
        ...
        private List<Medication> CreateDemoMedications()
        {
            return new List<Medication>
            {
                ...
                new Medication("Dipirona Sódica", "500mg", "Comprimido", MedicationCategory.Analgesic, false, _demoTenantId, "Dipyrone", "Novartis", "Dipirona sódica mono-hidratada", "500mg", "Oral", false, null, null, null, "Analgésico e antitérmico"),
                new Medication("Dipirona Sódica", "1g", "Comprimido", MedicationCategory.Analgesic, false, _demoTenantId, "Dipyrone", "EMS", "Dipirona sódica", "1g", "Oral", false, null, null, null, "Analgésico forte"),
                new Medication("Dipirona Gotas", "500mg/ml", "Solução Oral", MedicationCategory.Analgesic, false, _demoTenantId, "Dipyrone", "Medley", "Dipirona sódica", "500mg/ml", "Oral", false, null, null, null, "Gotas para dor e febre"),
                new Medication("Paracetamol", "750mg", "Comprimido", MedicationCategory.Analgesic, false, _demoTenantId, "Acetaminophen", "Medley", "Paracetamol", "750mg", "Oral", false, null, null, null, "Analgésico e antitérmico"),
                new Medication("Paracetamol", "500mg", "Comprimido", MedicationCategory.Analgesic, false, _demoTenantId, "Acetaminophen", "EMS", "Paracetamol", "500mg", "Oral", false, null, null, null, "Analgésico"),
                new Medication("Paracetamol Gotas", "200mg/ml", "Solução Oral", MedicationCategory.Analgesic, false, _demoTenantId, "Acetaminophen", "Prati-Donaduzzi", "Paracetamol", "200mg/ml", "Oral", false, null, null, null, "Gotas pediátricas"),
                new Medication("Tramadol", "50mg", "Cápsula", MedicationCategory.Analgesic, true, _demoTenantId, "Tramadol", "Pfizer", "Cloridrato de tramadol", "50mg", "Oral", true, ControlledSubstanceList.A1_Narcotics, null, null, "Analgésico opioide"),
                new Medication("Tramadol", "100mg", "Comprimido", MedicationCategory.Analgesic, true, _demoTenantId, "Tramadol", "EMS", "Cloridrato de tramadol", "100mg", "Oral", true, ControlledSubstanceList.A1_Narcotics, null, null, "Analgésico opioide forte"),
                new Medication("Codeína + Paracetamol", "30mg/500mg", "Comprimido", MedicationCategory.Analgesic, true, _demoTenantId, "Codeine/Paracetamol", "Sanofi", "Fosfato de codeína + Paracetamol", "30mg/500mg", "Oral", true, ControlledSubstanceList.A1_Narcotics, null, null, "Tylex - Analgésico opioide"),
                new Medication("Morfina", "10mg", "Comprimido", MedicationCategory.Analgesic, true, _demoTenantId, "Morphine", "Cristália", "Sulfato de morfina", "10mg", "Oral", true, ControlledSubstanceList.A1_Narcotics, null, null, "Analgésico opioide forte - uso controlado"),

                // Anti-inflamatórios / Anti-inflammatory
                new Medication("Ibuprofeno", "600mg", "Comprimido", MedicationCategory.AntiInflammatory, false, _demoTenantId, "Ibuprofen", "Pfizer", "Ibuprofeno", "600mg", "Oral", false, null, null, null, "Anti-inflamatório não esteroidal"),
                new Medication("Ibuprofeno", "400mg", "Comprimido", MedicationCategory.AntiInflammatory, false, _demoTenantId, "Ibuprofen", "EMS", "Ibuprofeno", "400mg", "Oral", false, null, null, null, "AINE"),
                new Medication("Ibuprofeno Gotas", "50mg/ml", "Solução Oral", MedicationCategory.AntiInflammatory, false, _demoTenantId, "Ibuprofen", "Aché", "Ibuprofeno", "50mg/ml", "Oral", false, null, null, null, "Alivium infantil"),
                new Medication("Naproxeno", "500mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Naproxen", "Roche", "Naproxeno sódico", "500mg", "Oral", false, null, null, null, "AINE de longa duração"),
                new Medication("Nimesulida", "100mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Nimesulide", "Aché", "Nimesulida", "100mg", "Oral", false, null, null, null, "AINE seletivo COX-2"),
                new Medication("Diclofenaco Sódico", "50mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Diclofenac", "Novartis", "Diclofenaco sódico", "50mg", "Oral", false, null, null, null, "Voltaren - AINE"),
                new Medication("Diclofenaco Potássico", "50mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Diclofenac", "EMS", "Diclofenaco potássico", "50mg", "Oral", false, null, null, null, "Cataflam - AINE de rápida absorção"),
                new Medication("Cetoprofeno", "100mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Ketoprofen", "Sanofi", "Cetoprofeno", "100mg", "Oral", false, null, null, null, "Profenid - AINE"),
                new Medication("Meloxicam", "15mg", "Comprimido", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Meloxicam", "Boehringer", "Meloxicam", "15mg", "Oral", false, null, null, null, "AINE seletivo COX-2"),
                new Medication("Piroxicam", "20mg", "Cápsula", MedicationCategory.AntiInflammatory, true, _demoTenantId, "Piroxicam", "Pfizer", "Piroxicam", "20mg", "Oral", false, null, null, null, "Feldene - AINE"),

                // Antibióticos / Antibiotics
                new Medication("Amoxicilina", "500mg", "Cápsula", MedicationCategory.Antibiotic, true, _demoTenantId, "Amoxicillin", "EMS", "Amoxicilina tri-hidratada", "500mg", "Oral", false, null, null, null, "Antibiótico de amplo espectro"),
                new Medication("Amoxicilina", "875mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Amoxicillin", "GSK", "Amoxicilina tri-hidratada", "875mg", "Oral", false, null, null, null, "Antibiótico de amplo espectro - dose alta"),
                new Medication("Amoxicilina + Clavulanato", "875mg/125mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Amoxicillin/Clavulanate", "GSK", "Amoxicilina + Ácido clavulânico", "875mg/125mg", "Oral", false, null, null, null, "Clavulin - Antibiótico com inibidor de beta-lactamase"),
                new Medication("Azitromicina", "500mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Azithromycin", "Pfizer", "Azitromicina di-hidratada", "500mg", "Oral", false, null, null, null, "Zitromax - Macrolídeo"),
                new Medication("Azitromicina Suspensão", "200mg/5ml", "Pó para Suspensão", MedicationCategory.Antibiotic, true, _demoTenantId, "Azithromycin", "EMS", "Azitromicina", "200mg/5ml", "Oral", false, null, null, null, "Suspensão pediátrica"),
                new Medication("Ciprofloxacino", "500mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Ciprofloxacin", "Bayer", "Cloridrato de ciprofloxacino", "500mg", "Oral", false, null, null, null, "Cipro - Fluoroquinolona"),
                new Medication("Levofloxacino", "500mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Levofloxacin", "Sanofi", "Levofloxacino hemi-hidratado", "500mg", "Oral", false, null, null, null, "Tavanic - Fluoroquinolona"),
                new Medication("Cefalexina", "500mg", "Cápsula", MedicationCategory.Antibiotic, true, _demoTenantId, "Cephalexin", "EMS", "Cefalexina mono-hidratada", "500mg", "Oral", false, null, null, null, "Cefalosporina de 1ª geração"),
                new Medication("Ceftriaxona", "1g", "Pó para Injeção", MedicationCategory.Antibiotic, true, _demoTenantId, "Ceftriaxone", "Roche", "Ceftriaxona dissódica", "1g", "Intravenosa/Intramuscular", false, null, null, null, "Cefalosporina de 3ª geração"),
                new Medication("Sulfametoxazol + Trimetoprima", "400mg/80mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "SMX/TMP", "Roche", "Sulfametoxazol + Trimetoprima", "400mg/80mg", "Oral", false, null, null, null, "Bactrim - Sulfonamida"),
                new Medication("Metronidazol", "400mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Metronidazole", "Sanofi", "Metronidazol", "400mg", "Oral", false, null, null, null, "Flagyl - Nitroimidazol"),
                new Medication("Clindamicina", "300mg", "Cápsula", MedicationCategory.Antibiotic, true, _demoTenantId, "Clindamycin", "Pfizer", "Cloridrato de clindamicina", "300mg", "Oral", false, null, null, null, "Dalacin C - Lincosamida"),
                new Medication("Doxiciclina", "100mg", "Comprimido", MedicationCategory.Antibiotic, true, _demoTenantId, "Doxycycline", "Pfizer", "Hiclato de doxiciclina", "100mg", "Oral", false, null, null, null, "Vibramicina - Tetraciclina"),

                // Anti-hipertensivos / Antihypertensives
                new Medication("Losartana Potássica", "50mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Losartan", "Merck", "Losartana potássica", "50mg", "Oral", false, null, null, null, "BRA - Bloqueador de receptor de angiotensina"),
                new Medication("Losartana Potássica", "100mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Losartan", "EMS", "Losartana potássica", "100mg", "Oral", false, null, null, null, "BRA - dose alta"),
                new Medication("Enalapril", "10mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Enalapril", "Merck", "Maleato de enalapril", "10mg", "Oral", false, null, null, null, "IECA - Inibidor da ECA"),
                new Medication("Enalapril", "20mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Enalapril", "EMS", "Maleato de enalapril", "20mg", "Oral", false, null, null, null, "IECA - dose alta"),
                new Medication("Captopril", "25mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Captopril", "Bristol-Myers", "Captopril", "25mg", "Oral", false, null, null, null, "Capoten - IECA"),
                new Medication("Anlodipino", "5mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Amlodipine", "Pfizer", "Besilato de anlodipino", "5mg", "Oral", false, null, null, null, "Norvasc - Bloqueador de canal de cálcio"),
                new Medication("Anlodipino", "10mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Amlodipine", "EMS", "Besilato de anlodipino", "10mg", "Oral", false, null, null, null, "BCC - dose alta"),
                new Medication("Atenolol", "50mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Atenolol", "AstraZeneca", "Atenolol", "50mg", "Oral", false, null, null, null, "Betabloqueador seletivo"),
                new Medication("Propranolol", "40mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Propranolol", "Sanofi", "Cloridrato de propranolol", "40mg", "Oral", false, null, null, null, "Betabloqueador não seletivo"),
                new Medication("Carvedilol", "6,25mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Carvedilol", "Roche", "Carvedilol", "6,25mg", "Oral", false, null, null, null, "Betabloqueador com ação vasodilatadora"),
                new Medication("Valsartana", "80mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Valsartan", "Novartis", "Valsartana", "80mg", "Oral", false, null, null, null, "Diovan - BRA"),
                new Medication("Hidroclorotiazida", "25mg", "Comprimido", MedicationCategory.Antihypertensive, true, _demoTenantId, "Hydrochlorothiazide", "Merck", "Hidroclorotiazida", "25mg", "Oral", false, null, null, null, "Diurético tiazídico"),

                // Diuréticos / Diuretics
                new Medication("Furosemida", "40mg", "Comprimido", MedicationCategory.Diuretic, true, _demoTenantId, "Furosemide", "Sanofi", "Furosemida", "40mg", "Oral", false, null, null, null, "Lasix - Diurético de alça"),
                new Medication("Espironolactona", "25mg", "Comprimido", MedicationCategory.Diuretic, true, _demoTenantId, "Spironolactone", "Pfizer", "Espironolactona", "25mg", "Oral", false, null, null, null, "Aldactone - Diurético poupador de potássio"),
                new Medication("Indapamida", "1,5mg", "Comprimido", MedicationCategory.Diuretic, true, _demoTenantId, "Indapamide", "Servier", "Indapamida", "1,5mg", "Oral", false, null, null, null, "Natrilix - Diurético tiazida-like"),

                // Anti-histamínicos / Antihistamines
                new Medication("Loratadina", "10mg", "Comprimido", MedicationCategory.Antihistamine, false, _demoTenantId, "Loratadine", "Schering-Plough", "Loratadina", "10mg", "Oral", false, null, null, null, "Claritin - Anti-histamínico de 2ª geração"),
                new Medication("Desloratadina", "5mg", "Comprimido", MedicationCategory.Antihistamine, false, _demoTenantId, "Desloratadine", "Merck", "Desloratadina", "5mg", "Oral", false, null, null, null, "Desalex - Anti-histamínico de 3ª geração"),
                new Medication("Cetirizina", "10mg", "Comprimido", MedicationCategory.Antihistamine, false, _demoTenantId, "Cetirizine", "UCB", "Dicloridrato de cetirizina", "10mg", "Oral", false, null, null, null, "Zyrtec - Anti-histamínico"),
                new Medication("Fexofenadina", "180mg", "Comprimido", MedicationCategory.Antihistamine, true, _demoTenantId, "Fexofenadine", "Sanofi", "Cloridrato de fexofenadina", "180mg", "Oral", false, null, null, null, "Allegra - Anti-histamínico"),
                new Medication("Hidroxizina", "25mg", "Comprimido", MedicationCategory.Antihistamine, true, _demoTenantId, "Hydroxyzine", "UCB", "Dicloridrato de hidroxizina", "25mg", "Oral", false, null, null, null, "Hixizine - Anti-histamínico com efeito sedativo"),
                new Medication("Prometazina", "25mg", "Comprimido", MedicationCategory.Antihistamine, true, _demoTenantId, "Promethazine", "Sanofi", "Cloridrato de prometazina", "25mg", "Oral", false, null, null, null, "Fenergan - Anti-histamínico sedativo"),

                // Antiácidos e protetores gástricos / Antacids
                new Medication("Omeprazol", "20mg", "Cápsula", MedicationCategory.Antacid, true, _demoTenantId, "Omeprazole", "AstraZeneca", "Omeprazol", "20mg", "Oral", false, null, null, null, "Losec - IBP"),
                new Medication("Omeprazol", "40mg", "Cápsula", MedicationCategory.Antacid, true, _demoTenantId, "Omeprazole", "EMS", "Omeprazol", "40mg", "Oral", false, null, null, null, "IBP - dose alta"),
                new Medication("Pantoprazol", "40mg", "Comprimido", MedicationCategory.Antacid, true, _demoTenantId, "Pantoprazole", "Takeda", "Pantoprazol sódico sesqui-hidratado", "40mg", "Oral", false, null, null, null, "Pantozol - IBP"),
                new Medication("Esomeprazol", "40mg", "Comprimido", MedicationCategory.Antacid, true, _demoTenantId, "Esomeprazole", "AstraZeneca", "Esomeprazol magnésio tri-hidratado", "40mg", "Oral", false, null, null, null, "Nexium - IBP"),
                new Medication("Ranitidina", "150mg", "Comprimido", MedicationCategory.Antacid, true, _demoTenantId, "Ranitidine", "GSK", "Cloridrato de ranitidina", "150mg", "Oral", false, null, null, null, "Antak - Antagonista H2"),
                new Medication("Hidróxido de Alumínio", "61,5mg/ml", "Suspensão Oral", MedicationCategory.Antacid, false, _demoTenantId, "Aluminum Hydroxide", "Sanofi", "Hidróxido de alumínio", "61,5mg/ml", "Oral", false, null, null, null, "Pepsamar - Antiácido"),

                // Antidiabéticos / Antidiabetics
                new Medication("Metformina", "850mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Metformin", "Bristol-Myers", "Cloridrato de metformina", "850mg", "Oral", false, null, null, null, "Glifage - Biguanida"),
                new Medication("Metformina", "500mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Metformin", "EMS", "Cloridrato de metformina", "500mg", "Oral", false, null, null, null, "Biguanida - dose inicial"),
                new Medication("Metformina XR", "500mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Metformin XR", "Merck", "Cloridrato de metformina", "500mg", "Oral", false, null, null, null, "Glifage XR - Liberação prolongada"),
                new Medication("Glibenclamida", "5mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Glibenclamide", "Sanofi", "Glibenclamida", "5mg", "Oral", false, null, null, null, "Daonil - Sulfonilureia"),
                new Medication("Glimepirida", "2mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Glimepiride", "Sanofi", "Glimepirida", "2mg", "Oral", false, null, null, null, "Amaryl - Sulfonilureia"),
                new Medication("Sitagliptina", "100mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Sitagliptin", "Merck", "Fosfato de sitagliptina", "100mg", "Oral", false, null, null, null, "Januvia - Inibidor de DPP-4"),
                new Medication("Empagliflozina", "25mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Empagliflozin", "Boehringer", "Empagliflozina", "25mg", "Oral", false, null, null, null, "Jardiance - Inibidor de SGLT2"),
                new Medication("Dapagliflozina", "10mg", "Comprimido", MedicationCategory.Antidiabetic, true, _demoTenantId, "Dapagliflozin", "AstraZeneca", "Dapagliflozina", "10mg", "Oral", false, null, null, null, "Forxiga - Inibidor de SGLT2"),
                new Medication("Insulina NPH", "100 UI/ml", "Suspensão Injetável", MedicationCategory.Antidiabetic, true, _demoTenantId, "Insulin NPH", "Novo Nordisk", "Insulina humana isofana", "100 UI/ml", "Subcutânea", false, null, null, null, "Insulina de ação intermediária"),
                new Medication("Insulina Regular", "100 UI/ml", "Solução Injetável", MedicationCategory.Antidiabetic, true, _demoTenantId, "Regular Insulin", "Eli Lilly", "Insulina humana regular", "100 UI/ml", "Subcutânea/Intravenosa", false, null, null, null, "Insulina de ação rápida"),

                // Ansiolíticos / Anxiolytics
                new Medication("Clonazepam", "2mg", "Comprimido", MedicationCategory.Anxiolytic, true, _demoTenantId, "Clonazepam", "Roche", "Clonazepam", "2mg", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Rivotril - Benzodiazepínico"),
                new Medication("Clonazepam Gotas", "2,5mg/ml", "Solução Oral", MedicationCategory.Anxiolytic, true, _demoTenantId, "Clonazepam", "Roche", "Clonazepam", "2,5mg/ml", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Rivotril Gotas"),
                new Medication("Alprazolam", "0,5mg", "Comprimido", MedicationCategory.Anxiolytic, true, _demoTenantId, "Alprazolam", "Pfizer", "Alprazolam", "0,5mg", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Frontal - Benzodiazepínico"),
                new Medication("Diazepam", "10mg", "Comprimido", MedicationCategory.Anxiolytic, true, _demoTenantId, "Diazepam", "Roche", "Diazepam", "10mg", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Valium - Benzodiazepínico"),
                new Medication("Bromazepam", "3mg", "Comprimido", MedicationCategory.Anxiolytic, true, _demoTenantId, "Bromazepam", "Roche", "Bromazepam", "3mg", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Lexotan - Benzodiazepínico"),
                new Medication("Lorazepam", "2mg", "Comprimido", MedicationCategory.Anxiolytic, true, _demoTenantId, "Lorazepam", "Pfizer", "Lorazepam", "2mg", "Oral", true, ControlledSubstanceList.B1_Psychotropics, null, null, "Lorax - Benzodiazepínico"),

                // Antidepressivos / Antidepressants
                new Medication("Sertralina", "50mg", "Comprimido", MedicationCategory.Antidepressant, true, _demoTenantId, "Sertraline", "Pfizer", "Cloridrato de sertralina", "50mg", "Oral", false, null, null, null, "Zoloft - ISRS"),
                new Medication("Escitalopram", "10mg", "Comprimido", MedicationCategory.Antidepressant, true, _demoTenantId, "Escitalopram", "Lundbeck", "Oxalato de escitalopram", "10mg", "Oral", false, null, null, null, "Lexapro - ISRS"),
                new Medication("Fluoxetina", "20mg", "Cápsula", MedicationCategory.Antidepressant, true, _demoTenantId, "Fluoxetine", "Eli Lilly", "Cloridrato de fluoxetina", "20mg", "Oral", false, null, null, null, "Prozac - ISRS"),
                new Medication("Paroxetina", "20mg", "Comprimido", MedicationCategory.Antidepressant, true, _demoTenantId, "Paroxetine", "GSK", "Cloridrato de paroxetina", "20mg", "Oral", false, null, null, null, "Paxil - ISRS"),
                new Medication("Venlafaxina", "75mg", "Cápsula", MedicationCategory.Antidepressant, true, _demoTenantId, "Venlafaxine", "Pfizer", "Cloridrato de venlafaxina", "75mg", "Oral", false, null, null, null, "Effexor - ISRSN"),
                new Medication("Duloxetina", "60mg", "Cápsula", MedicationCategory.Antidepressant, true, _demoTenantId, "Duloxetine", "Eli Lilly", "Cloridrato de duloxetina", "60mg", "Oral", false, null, null, null, "Cymbalta - ISRSN"),
                new Medication("Amitriptilina", "25mg", "Comprimido", MedicationCategory.Antidepressant, true, _demoTenantId, "Amitriptyline", "Eurofarma", "Cloridrato de amitriptilina", "25mg", "Oral", false, null, null, null, "Tryptanol - Antidepressivo tricíclico"),
                new Medication("Bupropiona", "150mg", "Comprimido", MedicationCategory.Antidepressant, true, _demoTenantId, "Bupropion", "GSK", "Cloridrato de bupropiona", "150mg", "Oral", false, null, null, null, "Wellbutrin - Inibidor de recaptação de norepinefrina-dopamina"),

                // Anticoagulantes / Anticoagulants
                new Medication("Varfarina", "5mg", "Comprimido", MedicationCategory.Anticoagulant, true, _demoTenantId, "Warfarin", "Bristol-Myers", "Varfarina sódica", "5mg", "Oral", false, null, null, null, "Marevan - Anticoagulante cumarínico"),
                new Medication("Rivaroxabana", "20mg", "Comprimido", MedicationCategory.Anticoagulant, true, _demoTenantId, "Rivaroxaban", "Bayer", "Rivaroxabana", "20mg", "Oral", false, null, null, null, "Xarelto - NOAC"),
                new Medication("Apixabana", "5mg", "Comprimido", MedicationCategory.Anticoagulant, true, _demoTenantId, "Apixaban", "Bristol-Myers", "Apixabana", "5mg", "Oral", false, null, null, null, "Eliquis - NOAC"),
                new Medication("AAS", "100mg", "Comprimido", MedicationCategory.Anticoagulant, false, _demoTenantId, "Aspirin", "Bayer", "Ácido acetilsalicílico", "100mg", "Oral", false, null, null, null, "Aspirina Prevent - Antiagregante plaquetário"),
                new Medication("Clopidogrel", "75mg", "Comprimido", MedicationCategory.Anticoagulant, true, _demoTenantId, "Clopidogrel", "Sanofi", "Bissulfato de clopidogrel", "75mg", "Oral", false, null, null, null, "Plavix - Antiagregante plaquetário"),
                new Medication("Enoxaparina", "40mg", "Solução Injetável", MedicationCategory.Anticoagulant, true, _demoTenantId, "Enoxaparin", "Sanofi", "Enoxaparina sódica", "40mg", "Subcutânea", false, null, null, null, "Clexane - Heparina de baixo peso molecular"),

                // Corticosteroides / Corticosteroids
                new Medication("Prednisona", "20mg", "Comprimido", MedicationCategory.Corticosteroid, true, _demoTenantId, "Prednisone", "Pfizer", "Prednisona", "20mg", "Oral", false, null, null, null, "Meticorten - Corticosteroide sistêmico"),
                new Medication("Prednisona", "5mg", "Comprimido", MedicationCategory.Corticosteroid, true, _demoTenantId, "Prednisone", "EMS", "Prednisona", "5mg", "Oral", false, null, null, null, "Corticosteroide - dose baixa"),
                new Medication("Dexametasona", "4mg", "Comprimido", MedicationCategory.Corticosteroid, true, _demoTenantId, "Dexamethasone", "Aché", "Dexametasona", "4mg", "Oral", false, null, null, null, "Decadron - Corticosteroide potente"),
                new Medication("Betametasona", "0,5mg", "Comprimido", MedicationCategory.Corticosteroid, true, _demoTenantId, "Betamethasone", "Schering-Plough", "Betametasona", "0,5mg", "Oral", false, null, null, null, "Celestone - Corticosteroide"),
                new Medication("Hidrocortisona Creme", "1%", "Creme", MedicationCategory.Corticosteroid, false, _demoTenantId, "Hydrocortisone", "Sanofi", "Acetato de hidrocortisona", "1%", "Tópica", false, null, null, null, "Corticosteroide tópico leve"),

                // Broncodilatadores / Bronchodilators
                new Medication("Salbutamol", "100mcg/dose", "Aerossol", MedicationCategory.Bronchodilator, true, _demoTenantId, "Salbutamol", "GSK", "Sulfato de salbutamol", "100mcg/dose", "Inalatória", false, null, null, null, "Aerolin - Beta-2 agonista de curta duração"),
                new Medication("Fenoterol", "100mcg/dose", "Aerossol", MedicationCategory.Bronchodilator, true, _demoTenantId, "Fenoterol", "Boehringer", "Bromidrato de fenoterol", "100mcg/dose", "Inalatória", false, null, null, null, "Berotec - Beta-2 agonista"),
                new Medication("Formoterol + Budesonida", "6mcg/200mcg", "Cápsula Inalatória", MedicationCategory.Bronchodilator, true, _demoTenantId, "Formoterol/Budesonide", "AstraZeneca", "Fumarato de formoterol + Budesonida", "6mcg/200mcg", "Inalatória", false, null, null, null, "Symbicort - Beta-2 agonista de longa duração + CI"),
                new Medication("Salmeterol + Fluticasona", "25mcg/250mcg", "Aerossol", MedicationCategory.Bronchodilator, true, _demoTenantId, "Salmeterol/Fluticasone", "GSK", "Xinafoato de salmeterol + Propionato de fluticasona", "25mcg/250mcg", "Inalatória", false, null, null, null, "Seretide - LABA + CI"),
                new Medication("Brometo de Ipratrópio", "20mcg/dose", "Aerossol", MedicationCategory.Bronchodilator, true, _demoTenantId, "Ipratropium", "Boehringer", "Brometo de ipratrópio", "20mcg/dose", "Inalatória", false, null, null, null, "Atrovent - Anticolinérgico"),

                // Vitaminas e Suplementos / Vitamins and Supplements
                new Medication("Vitamina D3", "7000 UI", "Cápsula", MedicationCategory.Vitamin, false, _demoTenantId, "Cholecalciferol", "Sanofi", "Colecalciferol", "7000 UI", "Oral", false, null, null, null, "Suplemento vitamínico"),
                new Medication("Vitamina D3", "50000 UI", "Cápsula", MedicationCategory.Vitamin, true, _demoTenantId, "Cholecalciferol", "Aché", "Colecalciferol", "50000 UI", "Oral", false, null, null, null, "Reposição de vitamina D"),
                new Medication("Vitamina B12", "1000mcg", "Comprimido", MedicationCategory.Vitamin, false, _demoTenantId, "Cyanocobalamin", "Merck", "Cianocobalamina", "1000mcg", "Oral", false, null, null, null, "Citoneurin - Vitamina B12"),
                new Medication("Complexo B", "variado", "Comprimido", MedicationCategory.Vitamin, false, _demoTenantId, "B Complex", "Pfizer", "Vitaminas do complexo B", "variado", "Oral", false, null, null, null, "Centrum - Polivitamínico"),
                new Medication("Ácido Fólico", "5mg", "Comprimido", MedicationCategory.Vitamin, false, _demoTenantId, "Folic Acid", "EMS", "Ácido fólico", "5mg", "Oral", false, null, null, null, "Suplemento para gestantes"),
                new Medication("Sulfato Ferroso", "40mg", "Comprimido", MedicationCategory.Supplement, true, _demoTenantId, "Ferrous Sulfate", "EMS", "Sulfato ferroso", "40mg", "Oral", false, null, null, null, "Suplemento de ferro"),
                new Medication("Cálcio + Vitamina D", "500mg/200UI", "Comprimido", MedicationCategory.Supplement, false, _demoTenantId, "Calcium/Vitamin D", "Sanofi", "Carbonato de cálcio + Colecalciferol", "500mg/200UI", "Oral", false, null, null, null, "Os-Cal - Suplemento ósseo"),
                new Medication("Ômega 3", "1000mg", "Cápsula", MedicationCategory.Supplement, false, _demoTenantId, "Omega-3", "Naturalis", "Óleo de peixe", "1000mg", "Oral", false, null, null, null, "Suplemento cardiovascular"),

                // Antifúngicos / Antifungals
                new Medication("Fluconazol", "150mg", "Cápsula", MedicationCategory.Antifungal, true, _demoTenantId, "Fluconazole", "Pfizer", "Fluconazol", "150mg", "Oral", false, null, null, null, "Zoltec - Antifúngico sistêmico"),
                new Medication("Itraconazol", "100mg", "Cápsula", MedicationCategory.Antifungal, true, _demoTenantId, "Itraconazole", "Janssen", "Itraconazol", "100mg", "Oral", false, null, null, null, "Sporanox - Antifúngico de amplo espectro"),
                new Medication("Cetoconazol", "200mg", "Comprimido", MedicationCategory.Antifungal, true, _demoTenantId, "Ketoconazole", "Janssen", "Cetoconazol", "200mg", "Oral", false, null, null, null, "Nizoral - Antifúngico"),
                new Medication("Nistatina Suspensão", "100000 UI/ml", "Suspensão Oral", MedicationCategory.Antifungal, true, _demoTenantId, "Nystatin", "Bristol-Myers", "Nistatina", "100000 UI/ml", "Oral", false, null, null, null, "Antifúngico para candidíase oral"),
                new Medication("Terbinafina", "250mg", "Comprimido", MedicationCategory.Antifungal, true, _demoTenantId, "Terbinafine", "Novartis", "Cloridrato de terbinafina", "250mg", "Oral", false, null, null, null, "Lamisil - Antifúngico"),

                // Antivirais / Antivirals
                new Medication("Aciclovir", "400mg", "Comprimido", MedicationCategory.Antiviral, true, _demoTenantId, "Acyclovir", "GSK", "Aciclovir", "400mg", "Oral", false, null, null, null, "Zovirax - Antiviral herpes"),
                new Medication("Valaciclovir", "500mg", "Comprimido", MedicationCategory.Antiviral, true, _demoTenantId, "Valacyclovir", "GSK", "Cloridrato de valaciclovir", "500mg", "Oral", false, null, null, null, "Valtrex - Pró-droga do aciclovir"),
                new Medication("Oseltamivir", "75mg", "Cápsula", MedicationCategory.Antiviral, true, _demoTenantId, "Oseltamivir", "Roche", "Fosfato de oseltamivir", "75mg", "Oral", false, null, null, null, "Tamiflu - Antiviral influenza"),

                // Antiparasitários / Antiparasitics
                new Medication("Albendazol", "400mg", "Comprimido Mastigável", MedicationCategory.Antiparasitic, true, _demoTenantId, "Albendazole", "GSK", "Albendazol", "400mg", "Oral", false, null, null, null, "Zentel - Antiparasitário"),
                new Medication("Ivermectina", "6mg", "Comprimido", MedicationCategory.Antiparasitic, true, _demoTenantId, "Ivermectin", "Merck", "Ivermectina", "6mg", "Oral", false, null, null, null, "Revectina - Antiparasitário"),
                new Medication("Mebendazol", "100mg", "Comprimido", MedicationCategory.Antiparasitic, true, _demoTenantId, "Mebendazole", "Janssen", "Mebendazol", "100mg", "Oral", false, null, null, null, "Pantelmin - Antiparasitário"),
                new Medication("Nitazoxanida", "500mg", "Comprimido", MedicationCategory.Antiparasitic, true, _demoTenantId, "Nitazoxanide", "Romark", "Nitazoxanida", "500mg", "Oral", false, null, null, null, "Annita - Antiparasitário e antiviral"),
                new Medication("Secnidazol", "1g", "Comprimido", MedicationCategory.Antiparasitic, true, _demoTenantId, "Secnidazole", "Sanofi", "Secnidazol", "1g", "Oral", false, null, null, null, "Antifúngico e antiprotozoário"),

                // Outros / Others
                new Medication("Domperidona", "10mg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Domperidone", "Janssen", "Domperidona", "10mg", "Oral", false, null, null, null, "Motilium - Antiemético"),
                new Medication("Metoclopramida", "10mg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Metoclopramide", "Sanofi", "Cloridrato de metoclopramida", "10mg", "Oral", false, null, null, null, "Plasil - Antiemético"),
                new Medication("Ondansetrona", "4mg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Ondansetron", "GSK", "Cloridrato de ondansetrona", "4mg", "Oral", false, null, null, null, "Zofran - Antiemético para quimioterapia"),
                new Medication("Simeticona", "125mg", "Comprimido", MedicationCategory.Other, false, _demoTenantId, "Simethicone", "Pfizer", "Simeticona", "125mg", "Oral", false, null, null, null, "Luftal - Antiflatulento"),
                new Medication("Loperamida", "2mg", "Cápsula", MedicationCategory.Other, false, _demoTenantId, "Loperamide", "Janssen", "Cloridrato de loperamida", "2mg", "Oral", false, null, null, null, "Imosec - Antidiarreico"),
                new Medication("Lactulose", "667mg/ml", "Xarope", MedicationCategory.Other, false, _demoTenantId, "Lactulose", "Solvay", "Lactulose", "667mg/ml", "Oral", false, null, null, null, "Lactulona - Laxante osmótico"),
                new Medication("Bisacodil", "5mg", "Comprimido", MedicationCategory.Other, false, _demoTenantId, "Bisacodyl", "Boehringer", "Bisacodil", "5mg", "Oral", false, null, null, null, "Dulcolax - Laxante estimulante"),
                new Medication("Sildenafila", "50mg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Sildenafil", "Pfizer", "Citrato de sildenafila", "50mg", "Oral", false, null, null, null, "Viagra - Tratamento de disfunção erétil"),
                new Medication("Finasterida", "1mg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Finasteride", "Merck", "Finasterida", "1mg", "Oral", false, null, null, null, "Propecia - Tratamento de calvície"),
                new Medication("Levotiroxina", "50mcg", "Comprimido", MedicationCategory.Other, true, _demoTenantId, "Levothyroxine", "Merck", "Levotiroxina sódica", "50mcg", "Oral", false, null, null, null, "Synthroid - Hormônio tireoidiano"),
                new Medication("Melatonina", "3mg", "Comprimido", MedicationCategory.Other, false, _demoTenantId, "Melatonin", "Medley", "Melatonina", "3mg", "Oral",false, null, null, null, "Regulador do sono")
            };
        }
