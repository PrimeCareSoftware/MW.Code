...
using MedicSoft.Patients.Api.Services;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "PrimeCare Software Patients Microservice",
        Version = "v1",
        Description = "Patients management microservice for PrimeCare Software system"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Patients Microservice v1");
