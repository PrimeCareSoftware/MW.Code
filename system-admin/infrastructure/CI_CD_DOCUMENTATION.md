...
Este documento descreve a implementação do pipeline de CI/CD para o Omni Care Software usando GitHub Actions.
...
- **Project Key**: Omni Care Software_MW.Code
...
**Configuração**:
- **Organization**: medicwarehouse
- **Project Key**: Omni Care Software_MW.Code_Frontend
