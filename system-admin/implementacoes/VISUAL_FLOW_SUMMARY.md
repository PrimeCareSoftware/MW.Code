# Resumo Visual dos Fluxos - Omni Care Software

## 🎯 Visão Geral do Sistema

Este documento apresenta um resumo visual rápido dos principais fluxos do sistema Omni Care Software.
...
```
┌────────────────────────────────────────────┐
│ [🏥 Omni Care Software] [Dashboard] [Pacientes] │
