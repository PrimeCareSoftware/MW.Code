...
namespace MedicSoft.Repository.Migrations.PostgreSQL
{
    ...
    [Migration("20260227225022_AddMustChangePasswordAndRemoveEmailTokenFK")]
    partial class AddMustChangePasswordAndRemoveEmailTokenFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.BlockedTimeSlot", b =>
                {
                    ...
                    b.HasIndex("TenantId", "RecurringPatternId")
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.ClinicPricingConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("ConsultationDiscountFixedAmount")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("ConsultationDiscountPercentage")
                        .HasColumnType("numeric");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<decimal>("DefaultConsultationPrice")
                        .HasColumnType("numeric");

                    b.Property<int>("DefaultProcedurePolicy")
                        .HasColumnType("integer");

                    b.Property<decimal?>("FollowUpConsultationPrice")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("TelemedicineConsultationPrice")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("ClinicPricingConfigurations");
                });
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<Guid?>("AppointmentProcedureId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AppointmentProcedureId");
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.ProcedurePricingConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("ConsultationPolicy")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProcedurePricingConfigurations");
                });
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.RecurrenceException", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "RecurringPatternId", "OriginalDate")
                        .HasDatabaseName("IX_RecurrenceExceptions_TenantId_PatternId_OriginalDate");

                    b.HasIndex("TenantId", "RecurringSeriesId", "OriginalDate")
                        .HasDatabaseName("IX_RecurrenceExceptions_TenantId_SeriesId_OriginalDate");

                    b.ToTable("RecurrenceExceptions", (string)null);
                });
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.RecurringAppointmentPattern", b =>
                {
                    ...
                    b.Property<Guid?>("ParentPatternId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ParentPatternId")
                    ...
                    b.HasIndex("TenantId", "ProfessionalId", "IsActive")
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.ReportTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f616b91-a3c8-49b4-853f-756ce6f8b95f"),
                            Category = "financial",
                            ...
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6921),
                        ...
                        new
                        {
                            Id = new Guid("ec8d247b-5f06-41f2-af82-75f73b152ee3"),
                            Category = "financial",
                            Configuration = "{\"parameters\":[{\"name\":\"month\",\"type\":\"month\",\"required\":true,\"label\":\"Report Month\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7304),
                        ...
                        new
                        {
                            Id = new Guid("6ff63cda-efe8-4bad-8ac1-79dabafed6d4"),
                            Category = "customer",
                            ...
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7389),
                        ...
                        new
                        {
                            Id = new Guid("ba3e3115-0092-427b-a54c-8fa1a5788ce6"),
                            Category = "customer",
                            Configuration = "{\"parameters\":[{\"name\":\"startDate\",\"type\":\"date\",\"required\":true,\"label\":\"Start Date\"},{\"name\":\"endDate\",\"type\":\"date\",\"required\":true,\"label\":\"End Date\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7481),
                        ...
                        new
                        {
                            Id = new Guid("ff559f0f-28f8-47fb-a8c2-b040f97df0ff"),
                            Category = "operational",
                            Configuration = "{\"parameters\":[{\"name\":\"startDate\",\"type\":\"date\",\"required\":true,\"label\":\"Start Date\"},{\"name\":\"endDate\",\"type\":\"date\",\"required\":true,\"label\":\"End Date\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7681),
                        ...
                        new
                        {
                            Id = new Guid("f5fcd172-1e53-48fd-8d88-fd5e025efb1f"),
                            Category = "operational",
                            Configuration = "{\"parameters\":[{\"name\":\"startDate\",\"type\":\"date\",\"required\":true,\"label\":\"Start Date\"},{\"name\":\"endDate\",\"type\":\"date\",\"required\":true,\"label\":\"End Date\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7783),
                        ...
                        new
                        {
                            Id = new Guid("43193b91-7c4b-456e-8e5d-a8834e8b7f95"),
                            Category = "clinical",
                            Configuration = "{\"parameters\":[{\"name\":\"clinicId\",\"type\":\"guid\",\"required\":false,\"label\":\"Clinic (Optional)\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7860),
                        ...
                        new
                        {
                            Id = new Guid("12ec77b1-f3b8-46ff-9dbf-9a7050292d59"),
                            Category = "operational",
                            Configuration = "{\"parameters\":[{\"name\":\"startDate\",\"type\":\"date\",\"required\":true,\"label\":\"Start Date\"},{\"name\":\"endDate\",\"type\":\"date\",\"required\":true,\"label\":\"End Date\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(7941),
                        ...
                        new
                        {
                            Id = new Guid("9578934c-46a7-4dc9-bef9-2b535566ad6f"),
                            Category = "financial",
                            Configuration = "{\"parameters\":[{\"name\":\"startDate\",\"type\":\"date\",\"required\":true,\"label\":\"Start Date\"},{\"name\":\"endDate\",\"type\":\"date\",\"required\":true,\"label\":\"End Date\"}]}",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(8017),
                        ...
                        new
                        {
                            Id = new Guid("34968057-dd06-4e32-8a8b-a1ffbfc3ac04"),
                            Category = "financial",
                            ...
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(8100),
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ProfessionalSpecialty")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ProfessionalSpecialty");
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.WidgetTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b48fb95-0d42-4f91-8937-1cdfaa5328f9"),
                            Category = "financial",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(4880),
                        ...
                        new
                        {
                            Id = new Guid("d1fb39dd-9b63-4cbc-a7d8-1b708db16e88"),
                            Category = "financial",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(5734),
                        ...
                        new
                        {
                            Id = new Guid("1414a845-5e13-4e4f-acb2-553259ddba0a"),
                            Category = "financial",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(5882),
                        ...
                        new
                        {
                            Id = new Guid("d8a1b5f3-1fda-4890-8b22-18d96173f724"),
                            Category = "customer",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6019),
                        ...
                        new
                        {
                            Id = new Guid("9b208193-f594-4a3e-846c-49a4658131ce"),
                            Category = "customer",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6084),
                        ...
                        new
                        {
                            Id = new Guid("7dd2fb1c-da05-4a0e-a503-c01e2caa5019"),
                            Category = "customer",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6186),
                        ...
                        new
                        {
                            Id = new Guid("60cecd53-06b7-4c02-b6dc-c0a4a156af18"),
                            Category = "operational",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6373),
                        ...
                        new
                        {
                            Id = new Guid("d14e2968-2e4d-459f-b45c-277a987b528e"),
                            Category = "operational",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6445),
                        ...
                        new
                        {
                            Id = new Guid("6250abfd-0ceb-496f-9031-bd843900d88d"),
                            Category = "operational",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6515),
                        ...
                        new
                        {
                            Id = new Guid("758493d7-63bc-467a-8879-14101c0035f6"),
                            Category = "clinical",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6598),
                        ...
                        new
                        {
                            Id = new Guid("70418ae5-13e5-43ff-bc56-4840444e42d0"),
                            Category = "clinical",
                            CreatedAt = new DateTime(2026, 2, 27, 22, 50, 20, 126, DateTimeKind.Utc).AddTicks(6729),
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("MedicSoft.Domain.Entities.AppointmentProcedure", "AppointmentProcedure")
                        .WithMany()
                        .HasForeignKey("AppointmentProcedureId");
            ...
            modelBuilder.Entity("MedicSoft.Domain.Entities.RecurringAppointmentPattern", b =>
                {
                    ...
                    b.HasOne("MedicSoft.Domain.Entities.RecurringAppointmentPattern", "ParentPattern")
                        .WithMany()
                        .HasForeignKey("ParentPatternId")
                        .OnDelete(DeleteBehavior.Restrict);
