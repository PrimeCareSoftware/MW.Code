...
{
    /// <inheritdoc />
    public partial class AddClinicPublicDisplaySettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderCnpj = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ProviderName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ProviderMunicipalRegistration = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ProviderStateRegistration = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ProviderAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ProviderCity = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ProviderState = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    ProviderZipCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    ClientCpfCnpj = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    ClientState = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    ClientZipCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    ServiceDescription = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    ...
                    IssRate = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    IssAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    IssRetained = table.Column<bool>(type: "boolean", nullable: false),
                    IrAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PisAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CofinsAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CsllAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    InssAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    RpsNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    CancellationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CancellationReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CancellationProtocol = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ReplacedInvoiceId = table.Column<Guid>(type: "uuid", nullable: true),
                    ReplacementInvoiceId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ElectronicInvoices_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ElectronicInvoices_Payments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    DefaultIssRate = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    IssRetainedByDefault = table.Column<bool>(type: "boolean", nullable: false),
                    IsSimplifiedTaxRegime = table.Column<bool>(type: "boolean", nullable: false),
                    SimplifiedTaxRegimeCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    ...
                    CertificateExpirationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CertificateThumbprint = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CurrentInvoiceNumber = table.Column<int>(type: "integer", nullable: false),
                    DefaultInvoiceSeries = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    CurrentRpsNumber = table.Column<int>(type: "integer", nullable: false),
                    Gateway = table.Column<int>(type: "integer", nullable: false),
                    GatewayApiKey = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    GatewayEnvironment = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    AutoIssueAfterPayment = table.Column<bool>(type: "boolean", nullable: false),
                    SendEmailAfterIssuance = table.Column<bool>(type: "boolean", nullable: false),
                    EmailTemplate = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    TenantId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinics_ShowOnPublicSite",
                table: "Clinics",
                column: "ShowOnPublicSite");

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_AccessKey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_AppointmentId",
                table: "ElectronicInvoices",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_PaymentId",
                table: "ElectronicInvoices",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_AppointmentId",
                table: "ElectronicInvoices",
                columns: new[] { "TenantId", "AppointmentId" });

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_ClientCpfCnpj",
                table: "ElectronicInvoices",
                columns: new[] { "TenantId", "ClientCpfCnpj" });

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_IssueDate",
                table: "ElectronicInvoices",
                columns: new[] { "TenantId", "IssueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_Number_Series",
                table: "ElectronicInvoices",
                columns: new[] { "TenantId", "Number", "Series" },
                unique: true,
                filter: "\"Number\" <> ''");

            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_PaymentId",
                table: "ElectronicInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectronicInvoices_TenantId_Type",
                table: "ElectronicInvoices",
                columns: new[] { "TenantId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceConfigurations_Cnpj",
                table: "InvoiceConfigurations",
                column: "Cnpj");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceConfigurations_TenantId",
                table: "InvoiceConfigurations",
                column: "TenantId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceConfigurations_TenantId_IsActive",
                table: "InvoiceConfigurations",
