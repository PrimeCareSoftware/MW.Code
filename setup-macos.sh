...
echo -e "   • Inicie com podman-compose ou individualmente"
echo ""
...
echo -e "   ${YELLOW}podman-compose -f podman-compose.microservices.yml up -d${NC}    # Inicia todos os microserviços"
echo -e "   ${YELLOW}podman-compose -f podman-compose.microservices.yml down${NC}     # Para todos os microserviços"
echo -e "   ${YELLOW}podman-compose -f podman-compose.microservices.yml logs -f${NC}  # Ver logs"
echo ""
...
echo -e "   1. ${YELLOW}podman-compose -f podman-compose.microservices.yml up -d${NC}"
