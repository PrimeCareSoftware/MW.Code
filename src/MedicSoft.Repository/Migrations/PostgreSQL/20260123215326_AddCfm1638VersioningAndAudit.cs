...
{
    /// <inheritdoc />
    public partial class AddCfm1638VersioningAndAudit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousVersionHash = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalRecordVersions_Users_ChangedById",
            ...
            migrationBuilder.CreateTable(
                name: "MedicalRecordSignatures",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MedicalRecordVersionId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SignedById = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    TenantId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalRecordSignatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalRecordSignatures_MedicalRecordVersions_MedicalRecord~",
                        column: x => x.MedicalRecordVersionId,
                        principalTable: "MedicalRecordVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalRecordSignatures_Users_SignedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecordSignatures_MedicalRecordVersionId",
                table: "MedicalRecordSignatures",
                column: "MedicalRecordVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecordSignatures_SignedById",
                table: "MedicalRecordSignatures",
                column: "SignedById");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecordVersions_ChangedById",
                table: "MedicalRecordVersions",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecordVersions_MedicalRecordId",
                table: "MedicalRecordVersions",
                column: "MedicalRecordId");
        }
