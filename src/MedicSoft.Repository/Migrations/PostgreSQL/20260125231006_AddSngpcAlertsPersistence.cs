...
{
    /// <inheritdoc />
    public partial class AddSngpcAlertsPersistence : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedRegistryId = table.Column<Guid>(type: "uuid", nullable: true),
                    RelatedBalanceId = table.Column<Guid>(type: "uuid", nullable: true),
                    RelatedMedication = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    AcknowledgmentNotes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SngpcAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SngpcAlerts_ControlledMedicationRegistries_RelatedRegistryId",
                        column: x => x.RelatedRegistryId,
                        principalTable: "ControlledMedicationRegistries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SngpcAlerts_MonthlyControlledBalances_RelatedBalanceId",
                        column: x => x.RelatedBalanceId,
                        principalTable: "MonthlyControlledBalances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SngpcAlerts_SNGPCReports_RelatedReportId",
                        column: x => x.RelatedReportId,
                        principalTable: "SNGPCReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SngpcAlerts_Users_AcknowledgedByUserId",
                        column: x => x.AcknowledgedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SngpcAlerts_Users_ResolvedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_AcknowledgedAt",
                table: "SngpcAlerts",
                column: "AcknowledgedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_AcknowledgedByUserId",
                table: "SngpcAlerts",
                column: "AcknowledgedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_CreatedAt",
                table: "SngpcAlerts",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_RelatedBalanceId",
                table: "SngpcAlerts",
                column: "RelatedBalanceId");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_RelatedRegistryId",
                table: "SngpcAlerts",
                column: "RelatedRegistryId");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_RelatedReportId",
                table: "SngpcAlerts",
                column: "RelatedReportId");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_ResolvedByUserId",
                table: "SngpcAlerts",
                column: "ResolvedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_TenantId_ResolvedAt",
                table: "SngpcAlerts",
                columns: new[] { "TenantId", "ResolvedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_TenantId_Severity",
                table: "SngpcAlerts",
                columns: new[] { "TenantId", "Severity" });

            migrationBuilder.CreateIndex(
                name: "IX_SngpcAlerts_TenantId_Type",
                table: "SngpcAlerts",
