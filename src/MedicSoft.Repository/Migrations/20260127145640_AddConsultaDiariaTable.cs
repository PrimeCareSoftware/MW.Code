...
{
    /// <inheritdoc />
    public partial class AddConsultaDiariaTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalConsultas = table.Column<int>(type: "integer", nullable: false),
                    ConsultasRealizadas = table.Column<int>(type: "integer", nullable: false),
                    ConsultasCanceladas = table.Column<int>(type: "integer", nullable: false),
                    NoShow = table.Column<int>(type: "integer", nullable: false),
                    ReceitaTotal = table.Column<decimal>(type: "numeric", nullable: false),
                    ReceitaRecebida = table.Column<decimal>(type: "numeric", nullable: false),
                    ReceitaPendente = table.Column<decimal>(type: "numeric", nullable: false),
                    TempoMedioEsperaMinutos = table.Column<int>(type: "integer", nullable: false),
                    TempoMedioConsultaMinutos = table.Column<int>(type: "integer", nullable: false),
                    TotalPacientesNovos = table.Column<int>(type: "integer", nullable: false),
                    TotalPacientesRetorno = table.Column<int>(type: "integer", nullable: false),
                    NpsMedio = table.Column<decimal>(type: "numeric", nullable: true),
                    TotalAvaliacoes = table.Column<int>(type: "integer", nullable: false),
                    DataConsolidacao = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultasDiarias", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataHoraEntrada = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DataHoraChamada = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DataHoraAtendimento = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DataHoraSaida = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
