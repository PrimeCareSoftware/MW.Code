# 🚀 Guia de Início Rápido - Executar Omni Care Software Localmente

> **Objetivo:** Colocar o sistema Omni Care Software rodando em seu PC para testes completos em menos de 10 minutos!
...
1. Importe a coleção: `Omni Care Software-Postman-Collection.json`
...
- **Clínica:** Clínica Demo Omni Care Software (TenantId: `demo-clinic-001`)
...
**Pronto! Agora você tem o Omni Care Software rodando localmente com dados completos para teste! 🎉**
