...
### Documentação do Omni Care Software
...
- **Omni Care Software Team** - Product Owner e QA
...
O Portal do Paciente é uma **aplicação separada** do Omni Care Software principal:
