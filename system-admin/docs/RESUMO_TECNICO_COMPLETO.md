# 📊 Resumo Técnico Completo - Omni Care Software
...
O **Omni Care Software** é um **sistema SaaS multitenant** completo para gestão de consultórios médicos, odontológicos e clínicas de saúde, construído com tecnologias modernas e arquitetura robusta.
...
mobile/
├── ios/                      # App iOS nativo
│   ├── Omni Care Software/      # Código Swift/SwiftUI
...
3. Importe Postman Collection: `Omni Care Software-Postman-Collection.json`
...
**Responsável:** Equipe Omni Care Software  
**Versão:** 2.0
