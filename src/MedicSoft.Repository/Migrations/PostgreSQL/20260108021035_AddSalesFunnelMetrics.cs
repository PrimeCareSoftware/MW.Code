...
{
    /// <inheritdoc />
    public partial class AddSalesFunnelMetrics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesFunnelMetrics", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_ClinicId",
                table: "SalesFunnelMetrics",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_CreatedAt",
                table: "SalesFunnelMetrics",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_IsConverted",
                table: "SalesFunnelMetrics",
                column: "IsConverted");

            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_SessionId",
                table: "SalesFunnelMetrics",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_SessionId_CreatedAt",
                table: "SalesFunnelMetrics",
                columns: new[] { "SessionId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SalesFunnelMetrics_Step_CreatedAt",
                table: "SalesFunnelMetrics",
