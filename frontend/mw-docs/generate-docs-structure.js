...
const CATEGORY_MAP = {
  ...
  'cfm-compliance': { name: '⚕️ CFM Compliance', icon: '⚕️' },
  'demandas': { name: '📋 Demandas', icon: '📋' },
  'docs': { name: '📚 Documentação Geral', icon: '📚' },
  'frontend': { name: '🎨 Frontend', icon: '🎨' },
  'guias': { name: '📖 Guias', icon: '📖' },
  'implementacoes': { name: '🔧 Implementações', icon: '🔧' },
  'infrastructure': { name: '🏗️ Infraestrutura', icon: '🏗️' },
  'regras-negocio': { name: '📋 Regras de Negócio', icon: '📋' },
